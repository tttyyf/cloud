...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="${appPath}/StudentQueryName"
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <form action="${appPath}/StudentUpdate">
                            <div class="panel-body">
                                ...
                                联系方式：<input type="text" name="s_phone" class="form-control"
                                            value="${UpdateStudent.s_phone}"> <br>
                                出生日期：<input type="text" name="s_bright" class="form-control"
                                            value="${UpdateStudent.s_bright}"> <br>
                                邮箱地址：<input type="text" name="s_email" class="form-control"
                                            value="${UpdateStudent.s_email}"> <br>
                                所属学年：<input type="text" name="s_grate" class="form-control"
                                            value="${UpdateStudent.s_grate}"> <br>
                                所属学期：<input type="text" name="s_term" class="form-control"
                                            value="${UpdateStudent.s_term}"> <br>
                                所属专业：
                                <select name="su_id" class="form-control">
                                ...
                                <br> 备注：
                                <textarea name="s_remark" class="form-control" value="${UpdateStudent.s_remark}"
                                          rows="4"></textarea>
                                <br>
                            </div>
                            <div class="row">
