...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="${appPath}/TeacherQueryName" class="navbar-form navbar-left">
                <div class="input-group">
                    <input type="text" value="${TeacherQueryName}" name="c_name" class="form-control"
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${TeacherList}" var="item">
                        <tr>
                            ...
                            <td>${item.t_email}</td>
                            <td>
                                <c:forEach items="${LessonList}" var="leitem">
                                    <c:if test="${item.l_id==leitem.l_id}"> ${leitem.l_name} </c:if>
                                </c:forEach>
                            </td>
                            <td>${item.t_phone}</td>
                            <td>
                                <button type="button" class="btn btn-success">
                                    <a href="${appPath}/TeacherToUpdate?t_id=${item.t_id}">编辑</a>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    <a href="${appPath}/TeacherDelete?t_id=${item.t_id}">删除</a>
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
