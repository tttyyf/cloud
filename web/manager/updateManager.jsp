...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="/WebTest/ManagerQueryName"
                  class="navbar-form navbar-left">
                <div class="input-group">
                    <input type="text" value="${ManagerQueryName}" name="e_name"
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <form action="${appPath}/ManagerUpdate">
                            <div class="panel-body">
                                <input type="hidden" name="e_id" class="form-control" value="${UpdateManager.e_id}">
                                姓名：<input type="text" name="e_name" class="form-control" value="${UpdateManager.e_name}"> <br>
                                密码：<input type="text" name="e_password" class="form-control" value="${UpdateManager.e_password}"> <br>
                            </div>
                            <div class="row">
