            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">添加专业数据</h3>
                    </div>
                    <!-- 表单用于提交数据  action="${appPath}/insertStudent" -->
                    <form action="${appPath}/SubjectInsert">
                        <div class="panel-body">
                            专业：
                            <input type="text" name="su_name" class="form-control" placeholder="请输入专业">
                            <br> 描述：
                            <input type="text" name="su_describe" class="form-control" placeholder="请输入描述">
                            <br> 所属学院：
