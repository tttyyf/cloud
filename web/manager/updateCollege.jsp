...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="${appPath}/CollegeQueryName"
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">学院管理模块</h3>
                <div class="row">
                    <!-- INPUTS -->
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">修改学院信息</h3>
                        </div>
                        <!-- 表单用于提交数据  action="${appPath}/StudentUpdate" -->
                        <form action="${appPath}/CollegeUpdate">
                            <div class="panel-body">
                                <input type="hidden" name="c_id" value="${UpdateCollege.c_id}"/>
                                学院名：<input type="text" name="c_name" class="form-control"
                                           placeholder="请输入需修改的学院新名称" value="${UpdateCollege.c_name}"/> <br>
                            </div>
                            <div class="row">
