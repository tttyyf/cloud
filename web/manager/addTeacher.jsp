...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="${appPath}/CollegeQueryName" class="navbar-form navbar-left">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <!-- 表单用于提交数据  action="${appPath}/insertStudent" -->
                        <form action="${appPath}/TeacherInsert">
                            <div class="panel-body">
                                教师名字：
                                <input type="text" name="t_name" class="form-control" placeholder="请输入教师名字">
                                <br> 教师密码：
                                <input type="text" name="t_password" class="form-control" placeholder="请输入教师密码">
                                </select>
                                <br> 性别：
                                <div class="chooseSex">
                                ...
                                <br> 邮箱：
                                <input type="text" name="t_email" class="form-control" placeholder="请输入邮箱地址">
                                <br> 所授课程：
                                ...
                                <br> 联系方式：
                                <input type="text" name="t_phone" class="form-control" placeholder="请输入联系方式">
                            </div>
                            <div class="row">
