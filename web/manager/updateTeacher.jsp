...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="brand">
            <a href="${appPath}/manager/ManagerTables.jsp"><img src="${appPath}/assets/img/logo.png" alt="Klorofil Logo"
        ...
        <div class="container-fluid">
            ...
            <form action="${appPath}/TeacherQueryName"
                  class="navbar-form navbar-left">
                <div class="input-group">
                    <input type="text" value="${TeacherQueryName}" name="c_name"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="chooseSex">
                                    <label class="fancy-radio">
                                        <input name="t_sex" value="男" type="radio"
