...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="${appPath}/StudentQueryName" class="navbar-form navbar-left">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success">
                                    <a href="${appPath}/StudentToUpdate?s_id=${item.s_id}">编辑</a>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    <a href="${appPath}/StudentDelete?s_id=${item.s_id}">删除</a>
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
