                ...
                <div class="row">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">添加学院信息</h3>
                        </div>
                        <!-- 表单用于提交数据  action="${appPath}/insertStudent" -->
                        <form action="${appPath}/CollegeInsert">
                            <div class="panel-body">
                                课程名：<input type="text" name="c_name" class="form-control"
                                           placeholder="请输入课程名"> <br>
                            </div>
                            <div class="row">
