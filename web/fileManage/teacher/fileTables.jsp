...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form id="form_query" action="${appPath}/TeaFileQueryName" class="navbar-form navbar-left">
                <div class="input-group">
                    <input id="page" name="pageNo" type="hidden" value="1"/>
                    <input type="text" value="${FileQueryName}" name="f_name" class="form-control"
            ...
            <div class="navbar-btn navbar-btn-right">
                <a class="btn btn-success update-pro"
                   ...
                   title="Update information" target="_blank"><i class="fa fa-rocket"></i>
    ...
    <div class="main">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">当前教学文件信息</h3>
            </div>
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${FileList}" var="item">
                        ...
                        <tr>
                            ...
                            <td>${item.f_path}</td>
                            <td>
                                <form action="${appPath}/FileDown" method="post" enctype="multipart/form-data">
                                    <button type="button" class="btn btn-success"><a
                                            href="${appPath}/FileDown?f_name=${item.f_name}">下载</a></button>
                                </form>
                            </td>
                        </tr>
                    </c:forEach>
