...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form id="form_query" action="${appPath}/FileQueryName" class="navbar-form navbar-left">
                <div class="input-group">
                    <input id="page" name="pageNo" type="hidden" value="1"/>
                    <input type="text" value="${FileQueryName}" name="e_name" class="form-control"
            ...
            <!-- 分页的form
            <form id="form_query" action="${appPath}/ManagerQuery" class="navbar-form navbar-left">
                    <input id="page" name="pageNo" type="hidden" value="1" />
            </form>
            -->
    ...
    <div class="main">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">上传教学文件</h3>
            </div>
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <tr>
                        <form action="${appPath}/FileUp" method="post" enctype="multipart/form-data">
