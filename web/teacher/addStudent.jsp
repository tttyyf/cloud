            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <!-- 表单用于提交数据  action="${appPath}/AddStudent" -->
                        <form action="${appPath}/TeaStudentAdd">
                            <div class="panel-body">
                                学生姓名：<input type="text" name="s_name" class="form-control"
                                            placeholder="请输入姓名"> <br> 联系方式：<input type="text"
                                ...
                                <br> 所属学年：<input type="text" name="s_grate"
                                                 class="form-control" placeholder="请输入学年"> <br>
                                所属学期：<input type="text" name="s_term" class="form-control"
                                            placeholder="请输入学期"> <br>
                                ...
                                <div class="chooseSex">
                                    <label class="fancy-radio"> <input
                                            name="s_sex" value="男" type="radio"> <span><i></i>男</span>
                                    </label> <label class="fancy-radio"> <input name="s_sex"
                                                                                value="女" type="radio">
                                    <span><i></i>女</span>
                                </label>
                                </div>
