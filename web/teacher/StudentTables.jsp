...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="${appPath}/TeaStudentQueryName" class="navbar-form navbar-left">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${StudentList}" var="item">
                        <tr>
                            ...
                            <td>${item.s_phone}</td>
                            <td>
                                <c:forEach items="${SubjectList}" var="suitem">
                                    <c:if test="${item.su_id==suitem.su_id}"> ${suitem.su_name} </c:if>
                                </c:forEach>
                            </td>
                            <td>${item.s_remark}</td>
                            <td>
                                <button type="button" class="btn btn-success">
                                    <a href="${appPath}/TeaStudentToUpdate?s_id=${item.s_id}">编辑</a>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    <a href="${appPath}/TeaStudentDelete?s_id=${item.s_id}">删除</a>
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
