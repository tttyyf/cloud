    ...
    <div class="main">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">个人信息展示</h3>
            </div>
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>${login_teacher.t_id}</td>
                        <td>${login_teacher.t_name}</td>
                        <td>${login_teacher.t_sex}</td>
                        <td>${login_teacher.t_email}</td>
                        <td>
                            <c:forEach items="${LessonList}" var="leitem">
                                <c:if test="${login_teacher.l_id==leitem.l_id}"> ${leitem.l_name} </c:if>
                            </c:forEach>
                        </td>
                        <td>${login_teacher.t_phone}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
