...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <form action="${appPath}/TeaLessonQueryName" class="navbar-form navbar-left">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${LessonList}" var="item">
                        <tr>
                            ...
                            <td>
                                <c:if test="${item.l_require}">必修</c:if>
                                <c:if test="${!item.l_require}">选修</c:if>
                            </td>
                            <td>
                            ...
                            <td>
                                <button type="button" class="btn btn-success">
                                    <a href="${appPath}/TeaLessonToUpdate?l_id=${item.l_id}">编辑</a>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    <a href="${appPath}/TeaLessonDelete?l_id=${item.l_id}">删除</a>
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
