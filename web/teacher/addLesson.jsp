            ...
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="#subles" data-toggle="collapse" class="collapsed"><i
                            class="lnr lnr-user"></i> <span>课程管理</span> <i
                            class="icon-submenu lnr lnr-chevron-left"></i></a>
                    ...
                    <li><a href="#subper" data-toggle="collapse" class="collapsed"><i
                            class="lnr lnr-chart-bars"></i> <span>个人信息管理</span> <i
                            class="icon-submenu lnr lnr-chevron-left"></i></a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <form action="${appPath}/TeaLessonInsert">
                            <div class="panel-body">
                                课程名：<input type="text" name="l_name" class="form-control"
                                           placeholder="请输入课程名"> <br> 学分：<input type="text"
                                                                                name="l_score" class="form-control"
                                                                                placeholder="请输入学分">
                                <br> 学时：<input type="text" name="l_time"
                                               class="form-control" placeholder="请输入学时"> <br>
                                所属学院： <select name="c_id" class="form-control">
                                <c:forEach items="${CollegeList}" var="item">
                                    <option value="${item.c_id}">${item.c_name}</option>
                                </c:forEach>
                            </select> <br> 是否必修：
                                <div class="chooseSub"><label class="fancy-radio"> <input
                                        name="l_require" value="1" type="radio" checked="checked">
                                    <span><i></i>是</span>
                                ...
                                <br> 描述：
                                <textarea name="l_describe" class="form-control"
