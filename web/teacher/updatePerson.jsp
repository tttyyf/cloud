...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="brand">
            <a href="${appPath}/teacher/TeacherTables.jsp"><img src="${appPath}/assets/img/logo.png" alt="Klorofil Logo" class="img-responsive logo"></a>
        </div>
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">个人信息管理模块</h3>
                <div class="row">
                    <!-- INPUTS -->
                    <div class="panel">
                        ...
                        <form action="${appPath}/TeaTeacherUpdate">
                            <div class="panel-body">
                                <input type="hidden" name="t_id" class="form-control" value="${login_teacher.t_id}">
                                姓名：<input type="text" name="t_name" class="form-control"
                                          placeholder="${login_teacher.t_name}" value="${login_teacher.t_name}">
                                <br>
                                密码：<input type="password" name="t_password" class="form-control"
                                          placeholder="${login_teacher.t_password}"
                                          value="${login_user3.png.t_password}">
                                <br>
                                邮箱地址：<input type="text" name="t_email" class="form-control"
                                            placeholder="${login_teacher.t_email}" value="${login_teacher.t_email}">
                                <br>
                                联系方式：<input type="text" name="t_phone" class="form-control"
                                            placeholder="${login_teacher.t_phone}" value="${login_teacher.t_phone}">
                                <br> 所授课程：
                                ...
                                <div class="chooseSex">
                                    <label class="fancy-radio">
                                        <input name="s_sex" value="男" type="radio"
                                               <c:if test="${login_teacher.t_sex=='男'}">checked="checked"</c:if>>
                                        <span><i></i>男</span>
                                    </label>
                                    <label class="fancy-radio">
                                        <input name="s_sex" value="女" type="radio"
                                               <c:if test="${login_teacher.t_sex=='女'}">checked="checked"</c:if>>
                                        <span><i></i>女</span>
                                    </label>
                                </div>
                            </div>
